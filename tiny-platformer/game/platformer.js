(function() { // module pattern
  ...
  function onkey(ev, key, down) {
    switch(key) {
      case KEY.LEFT:  player.left  = down; if (ev) ev.preventDefault(); return false;
      case KEY.RIGHT: player.right = down; if (ev) ev.preventDefault(); return false;
      case KEY.SPACE: player.jump  = down; if (ev) ev.preventDefault(); return false;
    }
  }
